...
<%@ page import="com.cpt.model.Student" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="content">
        ...
        <form action="/student/updateProfile" method="post">
            <div class="form-group">
                ...
                <input type="text" id="rollNo" value="<%= student.getRollNo() %>" disabled>
            </div>
            <div class="form-group">
                <label for="fullName">Full Name</label>
                <input type="text" id="fullName" name="fullName" value="<%= student.getFullName() %>" required>
            </div>
            <div class="form-group">
                <label for="collegeEmail">College Email</label>
                <input type="email" id="collegeEmail" name="collegeEmail" value="<%= student.getCollegeEmail() %>" required>
            </div>
            <div class="form-group">
                <label for="cgpa">CGPA</label>
                <input type="number" step="0.01" min="0" max="10" id="cgpa" name="cgpa" value="<%= student.getCgpa() %>" required>
            </div>
            <div class="form-group">
                <label for="backlogs">Backlogs</label>
                <input type="number" min="0" id="backlogs" name="backlogs" value="<%= student.getBacklogs() %>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="gender" name="gender" value="<%= student.getGender() != null ? student.getGender() : "" %>">
            </div>
