...
<head>
    ...
    <title>Upcoming Drives - Placement Tracking System</title>
    <style>
            ...
            <% if (drives != null) { %>
                <% for (PlacementDrive drive : drives) { %>
                    <tr>
                        ...
                        <td><%= drive.getPldEndDate() != null ? drive.getPldEndDate() : "N/A" %></td>
                    </tr>
                <% } %>
            <% } else { %>
                <tr><td colspan="4">No upcoming drives available.</td></tr>
            <% } %>
        </table>
    </div>
