...
<div class="hr-dashboard">
 <div class="sidebar">
        ...
        <div class="menu-container">
            ...
            <div class="menu-item" data-section="manageTeams" onclick="loadSection('manageTeams')">
                <i class="fas fa-users"></i>
                <span>Manage Teams</span>
            </div>
            <div class="menu-item" data-section="hiringForm" onclick="loadSection('hiringForm')">
                <i class="fas fa-building"></i>
                <span>Add Hiring Rounds</span>
            </div>
            <div class="menu-item" data-section="ScreeningForm" onclick="loadSection('ScreeningForm')">
                <i class="fas fa-bullseye"></i>
                <span>Set Screening Criteria</span>
            </div>
            <div class="menu-item" data-section="updateCompanyDetails" onclick="loadSection('updateCompanyDetails')">
                <i class="fas fa-edit"></i>
                <span>Edit Company Details</span>
            </div>
            <div class="menu-item" data-section="modify-threshold" onclick="loadSection('modify-threshold')">
                <i class="fas fa-edit"></i>
                <span>Modify Threshold</span>
            </div>
            <div class="menu-item" data-section="phaseWiseData" onclick="loadSection('phaseWiseData')">
                <i class="fas fa-list"></i>
                <span>Phase Wise Data</span>
            </div>
