...
<script>
        window.onload = function () {
            ...
            .then(data => {
                ...
                if (data.length === 0) {
                    tbody.innerHTML = "<tr><td colspan='3' style='text-align: center;'>No students found in drives.</td></tr>";
                    return;
                }
                ...
                data.forEach(student => {
                    ...
                    cell1.textContent = student["Roll No"];
                    row.appendChild(cell1);
                    const cell2 = document.createElement("td");
                    cell2.textContent = student["Full Name"];
                    row.appendChild(cell2);
                    const cell3 = document.createElement("td");
                    cell3.textContent = student["Drive Name"];
            ...
            .catch(error => {
                console.error("Error fetching students in drives:", error);
                const tbody = document.getElementById("studentsTableBody");
                tbody.innerHTML = "<tr><td colspan='3' style='text-align: center;'>Error loading data. Please try again.</td></tr>";
            });
        };
