...
<%@ page import="java.util.*, com.cpt.model.PlacementDrive" %>
...
<head>
    ...
    <title>Ongoing Drives - Placement Tracker</title>
        ...
        <div class="drives-list">
            ...
            <div class="drive-card">
                <div class="drive-details">
                    ...
                    <div class="drive-info">
                        ...
                        <div class="drive-meta">
                            <span><i class="fas fa-calendar"></i> <%= d.getStartDate() %></span>
                ...
                <form action="getCandidates/<%= d.getPldId() %>" method="get" style="display: inline;">
                    <button type="submit" class="popup-btn btn-primary">View Applications</button>
                </form>
                <form action="getShortListedCandidates/<%= d.getPldId() %>" method="get" style="display: inline;">
                    <button type="submit" class="popup-btn btn-primary">View Status</button>
                </form>
                <form action="getRoundWiseShortListedCandidates/<%= d.getPldId() %>" method="get" style="display: inline;">
                    <button type="submit" class="popup-btn btn-primary">Roundwise Status</button>
                </form>
            </div>
                <div class="drive-status">Ongoing</div>
            </div>
            ...
            %>
            <p>No ongoing drives available.</p>
            <%
                }
            %>
