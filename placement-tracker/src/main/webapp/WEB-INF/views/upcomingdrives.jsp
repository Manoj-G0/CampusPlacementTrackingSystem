...
<head>
    ...
    <title>Upcoming Drives - Placement Tracker</title>
...
<div class="main-content">
    ...
    <div class="section-title">Upcoming Drives</div>
    <div class="drives-section">
        <div class="drives-list">
            ...
            <div class="action-buttons">
                <a href="getCandidates/<%= d.getPldId() %>" class="btn">View Candidates</a>
            </div>
            <div class="drive-status">Upcoming</div>
            </div>
            <%
                    }
                } else {
